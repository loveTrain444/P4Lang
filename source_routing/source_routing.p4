...
parser MyParser(packet_in packet,
    ...
    state parse_ethernet {
         ...
         */
        // 如果以太网头部类型是TYPE_SRCROUTING（源路由），就转到parse_srcRouting状态，
        // 否则接收这个包
    ...
    state parse_srcRouting {
         ...
         */
        //  提取头部中源路由栈中定义的下一跳信息，如果是1说明已到达栈底，
        //  转到parse_ipv4状态；否则转到parse_srcrRouting状态。
...
control MyIngress(inout headers hdr,
    ...
    apply {
        ...
        if (hdr.srcRoutes[0].isValid()){
             ...
             */
             //如果已触底则调用srcRoute_finish函数将以太网类型转成IPV4
